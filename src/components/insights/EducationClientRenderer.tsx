...
const educationSections = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        - <strong>BNSS Section 35:</strong> Digital documentation and tracking
        - <strong>New requirement:</strong> Video recording of arrest in heinous crimes`,
        comparison: [
          {
    ...
    items: [
      {
        ...
        explanation: `<strong>Key provisions of Consumer Protection Act 2019:</strong>
        ...
        <strong>Case Examples:
        - Indian Medical Association v. V.P. Shantha (1995): Medical services under CPA
        - Laxmi Engineering Works v. PSG Industrial Institute (1995): Deficiency in service</strong>`,
      ...
      },
      {
        ...
        explanation: `<strong>Essential clauses in rental agreements:</strong>
        ...
        <strong>State-specific Rent Control Acts provide additional protections:</strong>
        - Delhi Rent Act: 1995
        - Maharashtra Rent Control Act: 1999
        - Model Tenancy Act 2021 (for new agreements)

        <strong>Landmark Cases:
        - Gian Devi Anand v. Jeevan Kumar (1985): Tenant protection
        - Bharat Sales Ltd. v. LIC (1998): Eviction procedures</strong>`,
        quickTips: [
    ...
    items: [
      {
        ...
        explanation: `<strong>Key changes in Bharatiya Nyaya Sanhita:</strong>
        1. Sedition replaced with <strong>"Acts against sovereignty" (Sec 152)</strong>
        2. Organized crime chapter added <strong>(Sec 111-120)</strong>
        3. Mob lynching punishable by death <strong>(Sec 103(2))</strong>
        4. Community service introduced for petty crimes <strong>(Sec 23)</strong>
        5. Gender-neutral rape laws (Sec 69)

        <strong>Comparison with IPC:</strong>
        - <strong>IPC Section 377:</strong> Decriminalized (Navtej Singh Johar v. UOI)
        - <strong>BNS Section 69:</strong> Expanded sexual offenses
        - <strong>New offense:</strong> Sexual intercourse by deceit <strong>(Sec 72)</strong>`,
        comparison: [
          {
            title: "Murder",
      ...
      },
      {
        ...
        explanation: `<strong>Revolutionary changes in Bharatiya Sakshya Adhiniyam:</strong>
        1. Electronic records primary evidence <strong>(Sec 61)</strong>
        2. No need for <strong>Section 65B</strong> certificate
        3. 32 types of electronic evidence recognized
        4. Hash verification for digital documents <strong>(Sec 63)</strong>
        5. Presumption of genuineness for official e-records <strong>(Sec 67)</strong>
        ...
        <strong>Case Reference:
        - Arjun Panditrao v. Kailash Kushanrao (2020): Clarified 65B requirement</strong>`,
        quickTips: [
    ...
    items: [
      {
        ...
        explanation: `<strong>Complete process under new BNSS:</strong>
        1. Can file at any police station <strong>(Zero FIR concept)</strong>
        ...
        - Priyanka Srivastava v. State of UP (2015): Penalty for false FIR</strong>`,
        quickTips: [
      ...
      },
      {
        ...
        explanation: `<strong>Indian judicial system structure:</strong>
        1. <strong>District Courts:</strong>
           - Civil Judge (Junior Division)
           - Civil Judge (Senior Division)
           - Additional District Judge
           - District Judge
        
        2. <strong>High Courts:</strong>
           - Original and appellate jurisdiction
           - Can issue writs under Article 226
        
        3. <strong>Supreme Court:</strong>
           - Final appellate court
           - Constitutional matters under Article 32
           - Special Leave Petitions under Article 136

        <strong>Appeal Process:</strong>
        - <strong>Magistrate's order → Sessions Court → High Court → Supreme Court
        - Time limits vary by case type (typically 30-90 days)</strong>`,
