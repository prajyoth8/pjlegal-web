    ...
    <AdminAuthGuard>
      <div className="min-h-screen bg-neutral-950 text-neutral-100">
        ...
        <header className="border-b border-neutral-800">
          <div className="max-w-7xl mx-auto px-4 py-4 sm:px-6 lg:px-8 flex justify-between items-center">
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-neutral-400 mt-1">Welcome, {userEmail}</p>
            </div>
            <button
              onClick={async () => {
                await supabase.auth.signOut();
              ...
              className="px-3 py-1.5 text-xs font-medium rounded-full border border-neutral-700 hover:bg-neutral-800/50 transition-colors"
            >
              Sign out
            </button>
          </div>
        ...
        <main className="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
          {/* Scraper Section */}
          <section className="mb-8">
            <div className="bg-neutral-900 rounded-xl p-5 border border-neutral-800 shadow-lg">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
                <div>
                  <h2 className="text-lg font-light text-neutral-200">Automated Content Scraper</h2>
          ...
          {/* Tab Content */}
          {activeTab === "logs" ? (
            <section className="mb-8 bg-neutral-900 rounded-xl border border-neutral-800 shadow-lg overflow-hidden">
              <div className="px-5 py-4 border-b border-neutral-800 flex justify-between items-center">
                <h3 className="text-base font-medium text-neutral-200">Scraper Activity</h3>
                ...
                <table className="min-w-full divide-y divide-neutral-800">
                  <thead className="bg-neutral-800/50">
                    <tr>
                      <th
                        scope="col"
                        className="px-5 py-3 text-left text-xs font-medium text-neutral-400 uppercase tracking-wider"
                      >
                        Time
                      </th>
                      <th
                  ...
                  <tbody className="divide-y divide-neutral-800">
                    {logs.map((log) => (
                      ...
                      >
                        ...
                        <td className="px-5 py-4 whitespace-nowrap text-sm font-medium text-neutral-200">
                          {log.source || "N/A"}
                        </td>
                        ...
                        <td className="px-5 py-4 text-sm text-neutral-400 max-w-xs truncate">
                          {log.details}
                        </td>
                      </tr>
                    ))}
            ...
            <section className="mb-8 bg-neutral-900 rounded-xl border border-neutral-800 shadow-lg overflow-hidden">
              <div className="px-5 py-4 border-b border-neutral-800 flex justify-between items-center">
                <h3 className="text-base font-medium text-neutral-200">Legal Documents</h3>
                <span className="text-xs px-2 py-1 rounded-full bg-neutral-800 text-neutral-400">
                  {laws.length} entries
                </span>
              </div>
                  ...
                  <tbody className="divide-y divide-neutral-800">
                    {laws.map((law) => (
                      <tr
                        ...
                        className="hover:bg-neutral-800/30 transition-colors duration-150"
                      >
                        <td className="px-5 py-4 text-sm font-medium text-neutral-200 max-w-xs">
                          {law.title}
                        </td>
                        <td className="px-5 py-4 whitespace-nowrap text-sm text-neutral-400">
                          {law.published_date
                            ? new Date(law.published_date).toLocaleDateString()
                            : "N/A"}
                        </td>
          ...
          <section className="bg-neutral-900 rounded-xl border border-neutral-800 shadow-lg overflow-hidden">
            <div className="px-5 py-4 border-b border-neutral-800">
              <h3 className="text-base font-medium text-neutral-200">Content Creation</h3>
            </div>
            <div className="p-5">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-neutral-900 rounded-lg p-5 border border-neutral-800">
                  <div className="flex items-center mb-4">
                    ...
                    <h4 className="ml-3 text-base font-medium text-neutral-200">Legal Document</h4>
                  </div>
                  <div className="space-y-4">
                    <div>
                      <label
                      ...
                      <input
                        ...
                        value={pasteTitle}
                        onChange={(e) => setPasteTitle(e.target.value)}
                        className="block w-full rounded-lg border-neutral-700 bg-neutral-800 focus:border-emerald-400 focus:ring-emerald-400/30 text-sm py-2 px-3 border shadow-sm text-neutral-200"
                      />
                    </div>
                    <div>
                      <label
                      ...
                      <textarea
                        ...
                        value={pasteContent}
                        onChange={(e) => setPasteContent(e.target.value)}
                        className="block w-full rounded-lg border-neutral-700 bg-neutral-800 focus:border-emerald-400 focus:ring-emerald-400/30 text-sm py-2 px-3 border shadow-sm text-neutral-200 h-32"
                      />
                    </div>
                    <div>
                      <label
                    ...
                    <button
                      onClick={handleSubmitText}
                      className="w-full flex justify-center py-2.5 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-emerald-600 hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-400/30 focus:ring-offset-2 focus:ring-offset-neutral-900 transition-colors"
                    >
                      Save Legal Document
                    </button>
                  </div>
                ...
                <div className="bg-neutral-900 rounded-lg p-5 border border-neutral-800">
                  <div className="flex items-center mb-4">
                    ...
                    <h4 className="ml-3 text-base font-medium text-neutral-200">Article/Blog Post</h4>
                  </div>
                  <div className="space-y-4">
                    <div>
                      <label
                      ...
                      <input
                        ...
                        value={articleTitle}
                        onChange={(e) => setArticleTitle(e.target.value)}
                        className="block w-full rounded-lg border-neutral-700 bg-neutral-800 focus:border-cyan-400 focus:ring-cyan-400/30 text-sm py-2 px-3 border shadow-sm text-neutral-200"
                      />
                    </div>
                    <div>
                      <label
                      ...
                      <textarea
                        ...
                        value={articleContent}
                        onChange={(e) => setArticleContent(e.target.value)}
                        className="block w-full rounded-lg border-neutral-700 bg-neutral-800 focus:border-cyan-400 focus:ring-cyan-400/30 text-sm py-2 px-3 border shadow-sm text-neutral-200 h-32"
                      />
                    </div>
                    <div>
                      <label
                    ...
                    <button
                      onClick={handleSubmitArticle}
                      className="w-full flex justify-center py-2.5 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-cyan-600 hover:bg-cyan-700 focus:outline-none focus:ring-2 focus:ring-cyan-400/30 focus:ring-offset-2 focus:ring-offset-neutral-900 transition-colors"
                    >
                      Publish Article
                    </button>
                  </div>
