...
export default function TokenUsagePage() {
  ...
  const estimatedCost = useMemo(() => ((totalTokens / 1000) * 0.002).toFixed(2), [totalTokens]);
      ...
      <div className={`min-h-screen ${colors.background} text-gray-100 p-4 md:p-8 space-y-6`}>
        ...
        <Grid numItems={1} numItemsSm={2} numItemsMd={3} className="gap-4 sm:gap-6">
          <Card className={`p-6 border ${colors.cardBorder} ${colors.cardBg} rounded-xl`}>
            ...
            <Metric className={`mt-2 text-3xl ${colors.accent.indigo}`}>
          ...
          <Card className={`p-6 border ${colors.cardBorder} ${colors.cardBg} rounded-xl`}>
            ...
            <Metric className={`mt-2 text-3xl ${colors.accent.emerald}`}>
        ...
        <Grid numItems={1} numItemsLg={2} className="gap-6">
          <Card className={`p-6 border ${colors.cardBorder} ${colors.cardBg} rounded-xl`}>
            <div className="flex items-center gap-2">
              ...
              <Title className={`text-lg font-semibold ${colors.textPrimary}`}>
                Daily Token Usage
              </Title>
            </div>
            <AreaChart
