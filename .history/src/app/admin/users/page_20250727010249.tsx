...
import {
  ...
  AlertTriangle,
  Search,
  X, Crown, Shield, UserPlus, Rocket, Sparkles,
} from "lucide-react";
    ...
    return periodFiltered.filter((item) =>
      fieldsToSearch.some((field) => {
        ...
        if (field.includes('.')) {
          ...
          return String(item[parent]?.[child] || "").toLowerCase().includes(searchTerm.toLowerCase());
        }
                    ...
                    <tr>
                      <td colSpan={4} className="p-6 text-center text-gray-500">
                        <div className="flex flex-col items-center justify-center py-8">
                          ...
                          <p className="text-gray-600">
                            {searchTerm ? "No bookings match your search" : "No consultation bookings found"}
                          </p>
                          {searchTerm && (
                            <button
                              onClick={clearSearch}
                    ...
                    <tr>
                      <td colSpan={4} className="p-6 text-center text-gray-500">
                        <div className="flex flex-col items-center justify-center py-8">
                          ...
                          <p className="text-gray-600">
                            {searchTerm ? "No offensive queries match your search" : "No offensive queries found"}
                          </p>
                          {searchTerm && (
                            <button
                              onClick={clearSearch}
