                    ...
                    <tr>
                      ...
                      >
                        <div className="flex items-center gap-1">
                          Title
                          <ChevronDown
                            className={`w-4 h-4 transition-transform ${sortConfig.key === "title" && sortConfig.direction === "asc" ? "rotate-180" : ""}`}
                          />
                        </div>
                      </th>
                      <th
                      ...
                      >
                        <div className="flex items-center gap-1">
                          Date
                          <ChevronDown
                            className={`w-4 h-4 transition-transform ${sortConfig.key === "created_at" && sortConfig.direction === "asc" ? "rotate-180" : ""}`}
                          />
                        </div>
                      </th>
                      <th
