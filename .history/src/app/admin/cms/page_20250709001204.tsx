    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white flex items-center justify-center">
        <div className="flex flex-col items-center">
          ...
          <p className="text-gray-800 font-medium">Loading CMS Dashboard...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white">
        ...
        <header className="bg-white/80 backdrop-blur-sm shadow-sm">
          <div className="max-w-7xl mx-auto px-4 py-4 sm:px-6 lg:px-8 flex justify-between items-center">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Legal Content Management</h1>
              <p className="text-sm text-gray-700">Welcome back, {userEmail}</p>
            </div>
            <button
              onClick={async () => {
                await supabase.auth.signOut();
        ...
        <main className="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
                ...
                <div className="flex flex-col md:flex-row gap-3 w-full md:w-auto">
                  <select
                    value={selectedSource}
                    onChange={(e) => setSelectedSource(e.target.value)}
                    className="block w-full rounded-md border-gray-300 shadow-sm focus:border-gray-500 focus:ring-gray-500 text-sm py-2 px-3 border bg-white"
                    disabled={isScraping}
                  >
                    <option value="">Select a source...</option>
                    {sources.map((s) => (
                  ...
                  <button
                    onClick={triggerScraper}
                    disabled={!selectedSource || isScraping}
                    className="inline-flex items-center justify-center rounded-md border border-transparent bg-gray-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed min-w-[120px] transition-colors"
                  >
                    {isScraping ? (
                      <>
                        <svg
          ...
          {activeTab === "logs" ? (
            <section className="mb-8 bg-white/80 backdrop-blur-sm shadow rounded-lg overflow-hidden">
              <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                <h3 className="text-lg font-medium text-gray-900">Scraper Activity</h3>
                <span className="text-sm text-gray-700">{logs.length} entries</span>
              </div>
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-gray-50">
            ...
            <section className="mb-8 bg-white/80 backdrop-blur-sm shadow rounded-lg overflow-hidden">
              <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                <h3 className="text-lg font-medium text-gray-900">Legal Documents</h3>
                <span className="text-sm text-gray-700">{laws.length} entries</span>
              </div>
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-gray-50">
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="border border-gray-200 rounded-lg p-6 bg-white/50">
                  <div className="flex items-center mb-4">
                    <div className="flex-shrink-0 bg-gray-600 rounded-md p-2">
                      <svg
                        className="h-5 w-5 text-white"
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        value={pasteTitle}
                        onChange={(e) => setPasteTitle(e.target.value)}
                        className="block w-full rounded-md border-gray-300 shadow-sm focus:border-gray-500 focus:ring-gray-500 text-sm py-2 px-3 border bg-white/70"
                      />
                    </div>
                    <div>
                      <label
                      ...
                      <textarea
                        ...
                        value={pasteContent}
                        onChange={(e) => setPasteContent(e.target.value)}
                        className="block w-full rounded-md border-gray-300 shadow-sm focus:border-gray-500 focus:ring-gray-500 text-sm py-2 px-3 border h-32 bg-white/70"
                      />
                    </div>
                    <div>
                      <label
                ...
                <div className="border border-gray-200 rounded-lg p-6 bg-white/50">
                  ...
                  <div className="space-y-4">
                    ...
                    <button
                      onClick={handleSubmitArticle}
                      className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-gray-500 hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-colors"
                    >
                      Publish Article
                    </button>
                  </div>
