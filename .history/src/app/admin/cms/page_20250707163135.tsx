...
export default function CMSPage() {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="border border-gray-200 rounded-lg p-6">
                ...
                <div className="space-y-4">
                  <div>
                    <label htmlFor="legal-title" className="block text-sm font-medium text-gray-700 mb-1">
                      Title
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label htmlFor="legal-content" className="block text-sm font-medium text-gray-700 mb-1">
                      Content
                    </label>
                    <textarea
                      id="legal-content"
                  ...
                  <div>
                    <label htmlFor="legal-tags" className="block text-sm font-medium text-gray-700 mb-1">
  ...
  options={{
    spellChecker: false,
    placeholder: "Write your article or blog content here in Markdown...",
    toolbar: ["bold", "italic", "heading", "|", "quote", "code", "link", "unordered-list", "ordered-list", "|", "preview"],
    status: false,
  }}
/>
