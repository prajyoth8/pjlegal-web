...
export default function CMSPage() {
  ...
  try {
    ...
    if (imageFile) {
      ...
      imageUrl = supabase.storage.from('article-images').getPublicUrl(fileName).data.publicUrl;
    }
              ...
              <div className="grid grid-cols-1 gap-6">
                ...
                <div className="bg-neutral-900 rounded-lg p-4 sm:p-5 border border-neutral-800">
                  ...
                  <div className="space-y-3 sm:space-y-4">
                    ...
                    <div>
  <label htmlFor="article-image" className="block text-xs sm:text-sm font-medium text-neutral-400 mb-1">
    Thumbnail Image
  </label>
  <input
    type="file"
