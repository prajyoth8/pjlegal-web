  ...
  return (
    <AdminAuthGuard>
      <div className="min-h-screen bg-neutral-950 text-neutral-100 overflow-hidden relative">
        ...
        {/* Main content */}
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 py-6 lg:px-8">
          ...
          >
            <div>
              <motion.h1
                whileHover={{ x: 2 }}
                className="text-2xl sm:text-3xl font-light tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-emerald-400 to-cyan-400"
              >
                Legal Document Hub
              </motion.h1>
              <p className="text-neutral-400 mt-1 text-sm sm:text-base">
                Manage all legal documents in one place
              </p>
            </div>
          ...
          {isLoading ? (
            ...
            >
              <motion.div
                ...
                className="h-10 w-10 sm:h-12 sm:w-12 border-2 border-transparent border-t-emerald-400 rounded-full"
              ></motion.div>
            </motion.div>
          ) : (
            <motion.div
