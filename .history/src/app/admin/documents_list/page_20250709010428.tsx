    ...
    <AdminAuthGuard>
      <div className="min-h-screen bg-neutral-950 text-neutral-100 overflow-hidden relative">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
          ...
          >
            <Link
              href="/admin/documents_list/upload"
              className="flex items-center justify-center w-14 h-14 rounded-full bg-gradient-to-br from-emerald-500 to-emerald-600 shadow-lg hover:shadow-emerald-500/30 transition-all duration-200"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
