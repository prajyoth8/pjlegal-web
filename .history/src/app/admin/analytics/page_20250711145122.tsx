...
export default function AnalyticsPage() {
  ...
  const [volumeInterval, setVolumeInterval] = useState<"daily" |"weekly" | "monthly" | "yearly">("daily");
...
<div className="border border-gray-800 bg-gray-900/50 rounded-xl p-6 backdrop-blur-sm">
  <div className="flex items-center justify-between mb-4">
    ...
    <select
      ...
      onChange={(e) => setVolumeInterval(e.target.value as "daily" | "weekly" | "monthly" | "yearly")}
    >
      ...
      <Bar
        data={{
          labels: volumeTrend.labels.map(label => {
            // Format weekly labels to be more readable (e.g., "Week 23, 2025")
          ...
          datasets: [
            {
              label: volumeInterval === "weekly" ? "Weekly Responses" : "Responses",
              data: volumeTrend.values,
        ...
        options={{
          ...
          scales: {
            ...
            x: {
              ...
              title: {
                display: true,
                text: volumeInterval === "weekly" ? "Week" : "Date",
                color: "#9CA3AF",
              }
            }
          }
