...
import { Bar, Line, Pie } from "react-chartjs-2";
import { RefreshCw, PieChart, BarChart, <LineGraph></LineGraph>, Database, Activity, Clock, Cpu, Zap, AlertTriangle } from "react-feather";
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="border border-gray-800 bg-gray-900/50 rounded-xl p-6 backdrop-blur-sm">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-lg font-semibold">Response Volume (Daily)</h2>
          </div>
          <div className="h-80">
            {loading ? (
              <div className="h-full w-full rounded-lg bg-gray-800/50 animate-pulse" />
