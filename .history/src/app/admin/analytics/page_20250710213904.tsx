  ...
  return (
    <div className="p-4 md:p-6 space-y-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard title="Total Prompts" value={totalRequests} change="+12%" icon="📈" />
        <StatCard title="OpenAI Usage" value={openaiCount} change="+8%" icon="🤖" />
        <StatCard title="DeepSeek Usage" value={deepseekCount} change="+24%" icon="🔍" />
        <StatCard title="Semantic Search" value={`${semanticPercent}%`} change="+5%" icon="🧠" />
      </div>
