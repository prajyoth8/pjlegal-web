...
// ✅ Dynamically load HybridLayout as a client component
const HybridLayout = dynamic(() => import("@/components/layout/HybridLayout"), {
  ssr: false,
});

// ✅ Valid server-side metadata export
          ...
          <div className="flex flex-col md:flex-row gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-700">
                ...
                <strong>Artificial Intelligence from IIT Roorkee</strong> and dual management
                degrees, I’ve now dedicated my energy and purpose to the legal profession.
              </p>
              <p className="text-gray-700">
            ...
            <div>
              ...
              <ul className="border-l-4 border-amber-500 pl-6 space-y-6 mt-4">
                ...
                <li>
                  ...
                  <p className="text-gray-700">
                    Worked across tech domains solving complex problems
                  </p>
                </li>
                <li>
