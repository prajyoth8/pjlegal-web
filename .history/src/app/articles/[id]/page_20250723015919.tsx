  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-10">
      ...
      <div className="flex gap-4 mt-10 border-t border-neutral-800 pt-6">
        <a
          href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(data.title)}&url=${encodeURIComponent(`https://pjlegal.in/insights?type=articles/${data.id}`)}`}
          target="_blank"
        ...
        <a
          href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(`https://pjlegal.in/insights?type=articles/${data.id}`)}`}
          target="_blank"
          rel="noopener noreferrer"
      ...
      <div className="mt-12 border-t border-neutral-800 pt-6">
        ...
        <ul className="list-disc pl-5 text-neutral-300 space-y-2">
          <li>
            <a href="/insights?type=articles/xyz123" className="text-cyan-400 hover:underline">
              Supreme Court's Take on Platform Workers (2025)
            </a>
          </li>
          <li>
            <a href="/insights?type=articles/abc456" className="text-cyan-400 hover:underline">
      ...
      <div className="flex justify-between items-center mt-10 text-sm text-neutral-400">
        ...
        {/* <a href={`/articles/${nextId}`} className="hover:text-cyan-400">Next Article &rarr;</a> */}
      </div>
    </div>
  );
}
