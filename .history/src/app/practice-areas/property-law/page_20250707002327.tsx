      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="relative z-10 p-8 md:p-12 lg:p-16">
            <div className="max-w-2xl">
              ...
              >
                Personalized legal guidance for all real estate matters with transparent pricing and clear communication.
              </motion.p>
              ...
              >
                ...
                <a href="#process" className="text-white border border-white/30 hover:border-white/60 px-6 py-3 rounded-lg font-medium transition-all hover:shadow-lg">
                  How We Work
                </a>
              </motion.div>
            </div>
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Comprehensive legal support for all your real estate needs with attention to detail and client-focused approach.
            </p>
          </div>
        ...
        <div id="process" className="mb-20">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Transparent steps to ensure you understand and are comfortable with every stage of your property legal matter.
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white p-6 rounded-xl border border-gray-200">
                ...
                <p className="text-gray-600">
                  Every client receives direct access to their attorney with prompt responses to all inquiries.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-xl border border-gray-200">
                ...
                <p className="text-gray-600">
                  We explain all legal documents in plain language so you understand every clause and implication.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-xl border border-gray-200">
                ...
                <p className="text-gray-600">
                  Property transactions often have deadlines - we prioritize meeting all critical dates.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-xl border border-gray-200">
                ...
                <p className="text-gray-600">
                  Clear fee structures with no hidden costs, including fixed-fee options for common services.
                </p>
              </div>
            </div>
          </div>
            ...
            {[
              {
                ...
                answer: "The registration process usually takes 1-2 weeks after document preparation, depending on Sub-Registrar office schedules."
              },
              {
                question: "What documents do I need for title verification?",
                answer: "You'll need the sale deed, previous title deeds, property tax receipts, encumbrance certificate, and survey documents."
              },
              {
                question: "Can I handle a property dispute without going to court?",
                answer: "Many disputes can be resolved through mediation or negotiation. We explore all alternative dispute resolution options first."
              },
              {
                question: "What's the difference between RERA and consumer court for builder disputes?",
                answer: "RERA specifically handles real estate developer issues with faster resolution, while consumer court has broader jurisdiction but longer timelines."
              }
            ].map((faq, i) => (
              <motion.div 
                key={i}
    ...
    >
      ...
      >
        ...
        <div className="p-8">
          ...
          <div className="prose prose-sm max-w-none text-gray-700 space-y-6 mb-8">
            {/* About Section */}
            <section>
            ...
            {services[activeIndex].modalContent?.legalReferences?.length > 0 && (
              <section>
                <h4 className="text-lg font-semibold text-gray-900">Relevant Legal References</h4>
