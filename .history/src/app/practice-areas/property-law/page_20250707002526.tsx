      ...
      >
        ...
        <div className="overflow-y-auto p-6 sm:p-8 flex-1">
          <button
            ...
            className="absolute top-4 right-4 text-gray-400 hover:text-black rounded-full p-1 hover:bg-gray-100 transition"
          >
            <X className="w-6 h-6" />
          </button>
          ...
          <div className="flex items-start gap-4 sm:gap-6 mb-6 sm:mb-8">
            ...
            <div>
              ...
              <div className="w-16 h-1 bg-gradient-to-r from-blue-500 to-purple-500 my-3 rounded-full"></div>
            </div>
          </div>
        ...
        {/* Action Buttons */}
        <div className="border-t border-gray-200 p-4 sm:p-6 flex flex-wrap justify-end gap-4 bg-white">
          <button
            onClick={() => {
              setActiveIndex(null);
              setModalOpen(true);
