      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="relative z-10 p-8 md:p-12 text-white">
            ...
            >
              Vigorous protection of your rights at every stage of criminal proceedings, from investigation through trial and appeal.
            </motion.p>
          </div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
              ...
              <ul className="space-y-4">
                {services.map((service, i) => (
                  <motion.li
                    ...
                    className={`${service.color} rounded-xl p-5 border border-gray-200 hover:shadow-md transition-all cursor-pointer group`}
                  ...
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="w-8 h-0.5 bg-purple-400 my-3 group-hover:w-12 transition-all duration-300"></div>
                      </div>
          ...
          >
            ...
            <div className="relative rounded-xl overflow-hidden shadow-lg border-4 border-white">
              <Image
                src="/assets/criminal-defense.jpg"
            ...
            <div className="bg-red-50 rounded-xl p-5 border border-red-200">
              ...
              <p className="text-sm text-red-700 mb-3">
                If you or a loved one has been arrested, contact us immediately for urgent legal intervention.
              </p>
              <a 
          ...
          >
            ...
            >
              ...
              <div className="flex items-start gap-4 mb-6">
                <div className={`${services[activeIndex].color} p-3 rounded-lg text-3xl`}>
                ...
                <div>
                  ...
                  <div className="w-12 h-1 bg-gradient-to-r from-purple-500 to-amber-500 my-3"></div>
                </div>
              </div>
