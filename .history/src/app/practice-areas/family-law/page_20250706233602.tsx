          ...
          <div className="space-y-6 sticky top-6">
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
              ...
              <p className="text-gray-600 text-sm italic">
                "PJ Legal guided me through a difficult divorce with compassion and expertise. They
                protected my rights while minimizing conflict, especially regarding child custody."
              </p>
            </div>
          </div>
        </div>
