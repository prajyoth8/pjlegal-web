...
import { Gavel, ArrowRight, BookOpenCheck, X, Check, HeartHandshake, Users, Shield, Home, Scale, Baby } from "lucide-react";
...
const services = [
  ...
  },
  {
    ...
    icon: <ChildIcon className="w-5 h-5" />, // Replaced Child with Baby icon
    color: "bg-amber-50",
          ...
          <div className="relative z-10 p-8 md:p-12 lg:p-16 text-white">
            ...
            >
              ...
              <p className="text-lg md:text-xl leading-relaxed mb-6">
                Navigating family legal matters with empathy and expertise to protect what matters most.
              </p>
            ...
            <div className="bg-white rounded-2xl shadow-sm p-6 border border-gray-100">
              <div className="mb-8">
                ...
                <p className="text-gray-600 max-w-2xl">
                  Our experienced attorneys provide personalized legal solutions for all family matters, 
                  from marriage to child custody, with sensitivity and discretion.
                </p>
              </div>
                ...
                {services.map((service, i) => (
                  ...
                  >
                    <div className="flex items-start gap-4">
                      <div className={`${service.textColor} p-2 rounded-lg`}>
                        {service.icon}
                      </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-white p-5 rounded-xl border border-gray-200">
                  ...
                  <p className="text-gray-600 text-sm">
                    We understand the emotional challenges of family disputes and provide supportive legal guidance.
                  </p>
                </div>
                <div className="bg-white p-5 rounded-xl border border-gray-200">
                  ...
                  <p className="text-gray-600 text-sm">
                    Whether through mediation or litigation, we seek resolutions that protect your family's best interests.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6 sticky top-6">
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
              ...
              <p className="text-gray-600 text-sm italic">
                "PJ Legal guided me through a difficult divorce with compassion and expertise. They protected my rights while minimizing conflict, especially regarding child custody."
              </p>
            </div>
          </div>
        </div>
          ...
          >
            ...
            >
              ...
              <div className="flex items-start gap-5 mb-6">
                <div className={`${services[activeIndex].color} ${services[activeIndex].textColor} p-3 rounded-xl`}>
