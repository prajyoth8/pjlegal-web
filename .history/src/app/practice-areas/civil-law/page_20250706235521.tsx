        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          >
            <p className="text-lg text-gray-800 leading-relaxed">
              <strong className="font-semibold text-purple-800">Civil Law</strong> governs private
              disputes between individuals, families, and institutions. At{" "}
              <strong className="font-semibold text-amber-700">PJ Legal</strong>, we specialize in
              protecting civil rights, securing remedies, and resolving complex legal conflicts
              across property, money, and contractual domains with a{" "}
              <span className="text-purple-700 font-medium">client-first approach</span>.
            </p>
          </motion.div>
        ...
        >
          <div className="relative aspect-square w-full rounded-xl overflow-hidden shadow-lg border-4 border-white">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent flex items-end p-6">
              <p className="text-white font-medium text-lg">Balanced Justice in Civil Matters</p>
            </div>
          </div>
