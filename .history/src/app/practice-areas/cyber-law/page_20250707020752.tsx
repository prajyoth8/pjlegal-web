...
// Service data - now includes ALL cards
const servicesData: CardItem[] = [
  {
    id: "ai-governance",
    title: "AI Governance",
    shortDescription: "Compliance frameworks for generative AI systems",
    ...
    legalBasis: [
      "Digital India Act (Upcoming Provisions)",
      "EU AI Act (Extraterritorial Impact)",
      "Algorithmic Accountability Principles"
    ],
    caseStudies: [
      "Successfully defended a SaaS provider against liability claims from AI-generated content",
  ...
  },
  {
    ...
    shortDescription: "End-to-end protection under DPDP Act 2023",
    ...
    caseStudies: [
      "Reduced compliance costs by 40% for a fintech startup",
      "Successfully represented client in India's first cross-border data transfer dispute"
    ]
  },
  {
    id: "digital-identity",
    title: "Digital Identity",
    shortDescription: "Biometric data protection solutions",
    ...
    caseStudies: [
      "Won ₹2.8Cr settlement in biometric data leak case",
      "Developed KYC compliance framework for India's largest private bank"
    ]
  },
  {
    id: "cybercrime-defense",
    title: "Cybercrime Defense",
    shortDescription: "Legal protection against digital offenses",
    longDescription: "Our cybercrime defense team provides immediate response to hacking incidents, online fraud, and digital extortion. We work with CERT-In and law enforcement to preserve evidence while protecting your rights.",
    icon: <ShieldCheck className="w-6 h-6" />,
    color: "bg-red-100",
    borderColor: "border-red-200",
    trend: "300% Increase Since 2020",
    stats: "Average resolution time: 72 hours",
    legalBasis: [
    ...
    caseStudies: [
      "Recovered ₹5.2Cr in cryptocurrency fraud case",
      "Successfully quashed FIR in false hacking allegation"
    ]
  }
];
...
const practiceAreas: CardItem[] = [
  {
    ...
    shortDescription: "Compliance for digital payments and blockchain",
    longDescription: "Specialized guidance for RBI's fintech regulations including digital lending, payment aggregators, and cryptocurrency frameworks.",
    icon: <Code className="w-6 h-6" />,
    color: "bg-amber-100",
    borderColor: "border-amber-200",
    trend: "Fastest Growing Sector",
    stats: "42% annual regulatory changes",
    legalBasis: [
    ...
    caseStudies: [
      "Secured license for India's first regulated crypto exchange",
      "Defended fintech startup against RBI compliance action"
    ]
  },
  {
    id: "cloud-security",
    title: "Cloud Security",
    shortDescription: "Legal frameworks for cloud computing",
    longDescription: "End-to-end compliance solutions for cloud service providers and enterprises using cloud infrastructure, including data localization requirements.",
    icon: <Cloud className="w-6 h-6" />,
    color: "bg-indigo-100",
    borderColor: "border-indigo-200",
    trend: "89% Adoption Rate",
    stats: "60% non-compliant with localization rules",
    legalBasis: [
      "MeitY Cloud Security Guidelines",
      "DPDP Act Data Storage Provisions",
      "Cross-Border Data Transfer Rules"
    ],
    caseStudies: [
      "Achieved compliance for multinational's India cloud deployment",
      "Negotiated SLA terms with major cloud providers"
    ]
  }
];

// Combined all cards for display
...
// Card Stack Component - Now shows ALL cards
  ...
  return (
    <PracticeDetailLayout title="Cyber Law" icon={<Globe className="w-6 h-6" />}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Card Stack - Now properly displays ALL cards based on view */}
        {view === "services" ? (
          <CardStack cards={servicesData} setActiveCard={setActiveCard} />
        ) : (
          <CardStack cards={practiceAreas} setActiveCard={setActiveCard} />
        )}
