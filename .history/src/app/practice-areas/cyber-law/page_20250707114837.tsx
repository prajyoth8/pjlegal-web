...
const services: ServiceCard[] = [
  {
    ...
    content: {
      overview:
        "With India's Digital India Act introducing AI-specific provisions in 2024, we help businesses implement compliant AI systems while mitigating liability risks from generative AI outputs.",
  ...
  },
  {
    ...
    content: {
      overview:
        "Our end-to-end DPDP Act compliance solutions help organizations avoid penalties up to ₹500 crore while building customer trust through robust data protection practices.",
  ...
  },
  {
    ...
    content: {
      overview:
        "Our 24/7 cybercrime response team works with CERT-In and law enforcement to contain breaches, preserve evidence, and protect your rights in digital offense cases.",
  ...
  },
  {
    ...
    content: {
      overview:
        "Specialized guidance for digital lending, payment aggregators, and cryptocurrency frameworks under India's rapidly evolving fintech regulatory landscape.",
        ...
        <div className="bg-gray-50 rounded-2xl p-8 mb-20">
          ...
          <div className="space-y-4">
            {emergingTrends.map((trend) => (
              <div key={trend.title} className="border-b border-gray-200 pb-4 last:border-0">
                <div
                ...
                >
                  ...
                  <ChevronDown
                    className={`w-5 h-5 text-gray-500 transition ${expandedTrend === trend.title ? "rotate-180" : ""}`}
                  />
                </div>
                <AnimatePresence>
            ...
            >
              ...
              >
                <div className="sticky top-0 z-10 bg-white border-b p-6 flex justify-between items-start">
                  <div className="flex items-start gap-4">
                    <div
                      className={`w-12 h-12 rounded-lg ${activeService.color} flex items-center justify-center`}
                    >
                      {activeService.icon}
                    </div>
                    <div>
