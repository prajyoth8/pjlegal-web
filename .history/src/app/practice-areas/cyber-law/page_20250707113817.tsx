    ...
    >
      ...
      >
        ...
        <div className="sticky bottom-0 bg-white border-t p-4 flex justify-end">
          ...
          <button className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-2 rounded-lg font-medium hover:shadow-md">
  ...
  const services = [
    {
      ...
      longDescription:
        "We provide comprehensive legal strategies for businesses implementing AI solutions, ensuring compliance with emerging regulations around algorithmic transparency, bias mitigation, and accountability. Our team stays ahead of developments in the Digital India Act provisions regarding AI.",
      icon: <Cpu className="w-6 h-6" />,
      color: "bg-purple-100",
    ...
    },
    {
      ...
      longDescription:
        "Our team helps organizations implement robust data governance frameworks to comply with India's new data protection regime. We conduct gap assessments, draft privacy policies, and establish breach response protocols to minimize legal and reputational risks.",
    ...
    },
    {
      ...
      longDescription:
        "We offer specialized counsel on Aadhaar Act compliance, biometric data storage regulations, and identity theft prevention. Our team has successfully handled multiple high-profile digital identity cases, including India's first biometric data breach class action.",
            ...
            {trends.map((trend) => (
              ...
              >
                <div
                  ...
                  onClick={() =>
                    setExpandedTrend(expandedTrend === trend.title ? null : trend.title)
                  }
                >
                  <div className="flex items-center gap-3 mb-4">
                    <div className="p-2 bg-blue-100 rounded-lg text-blue-600">{trend.icon}</div>
                  ...
                  <div className="mt-4 text-sm text-blue-600 flex items-center gap-1">
                    ...
                    <ChevronDown
                      className={`w-4 h-4 transition ${expandedTrend === trend.title ? "rotate-180" : ""}`}
                    />
                  </div>
                </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="flex-1">
              ...
              <p className="text-red-700 mb-4">
                If you're experiencing an active data breach, ransomware attack, or online
                extortion, contact our 24/7 response team immediately to preserve evidence and limit
                liability.
              </p>
              <a
                href="tel:+911234567890"
