...
// Modern "card stack" component instead of tiles
const CyberLawCards = ({ services, setActiveCard }) => {
  return (
...
// Animated stats component replacing hero section
const CyberStats = () => {
  const stats = [
    { value: "300%", label: "AI legal disputes increase", icon: <Cpu /> },
    { value: "72hr", label: "Data breach reporting mandate", icon: <Zap /> },
    { value: "₹500Cr", label: "Max DPDP Act penalty", icon: <ShieldCheck /> }
  ];
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-20">
      {stats.map((stat, i) => (
        ...
        >
          <div className="text-4xl font-bold mb-2 flex items-end gap-2">
            {stat.value}
...
export default function CyberLawPage() {
  ...
  const [view, setView] = useState<"trends" | "services">("trends");

  const services = [
    {
      title: "AI Governance",
      description: "Compliance frameworks for generative AI and automated decision systems",
      icon: <Cpu className="w-6 h-6" />,
      color: "bg-purple-100",
      borderColor: "border-purple-200",
      trend: "#1 Emerging Issue 2024"
    },
    {
      title: "Data Resilience",
      description: "End-to-end protection under India's DPDP Act 2023",
    ...
    },
    {
      ...
      description: "Biometric data protection and identity theft prevention",
      icon: <Fingerprint className="w-6 h-6" />,
      color: "bg-green-100",
      borderColor: "border-green-200",
      trend: "1.3M frauds/month"
    }
  ];
  ...
  const trends = [
    {
      ...
      description: "New liability frameworks for synthetic media"
    },
    {
      title: "Quantum Encryption",
      icon: <Lock className="w-5 h-5" />,
      description: "Preparing for post-quantum cryptography laws"
    },
    {
      title: "Neuro-Rights",
      icon: <Network className="w-5 h-5" />,
      description: "Regulating brain-data interfaces"
    }
  ];
  ...
  return (
    <PracticeDetailLayout title="Cyber Law" icon={<Globe className="w-6 h-6" />}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {/* Animated Stats Grid - Replaces Hero */}
        <CyberStats />
        ...
        <div className="flex justify-center mb-10">
          <div className="inline-flex bg-gray-100 rounded-full p-1">
            <button
              ...
              className={`px-4 py-2 rounded-full ${view === "trends" ? "bg-blue-600 text-white" : ""}`}
            >
              2024 Trends
            </button>
            <button
              onClick={() => setView("services")}
              className={`px-4 py-2 rounded-full ${view === "services" ? "bg-blue-600 text-white" : ""}`}
            >
              Our Solutions
            </button>
          </div>
        ...
        {/* Interactive Card Stack - Replaces Tiles */}
        {view === "services" ? (
          <CyberLawCards services={services} setActiveCard={setActiveCard} />
        ) : (
        ...
        {/* 3D Animated Model Placeholder */}
        <div className="my-20 relative h-64 bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl overflow-hidden border border-gray-200">
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center p-6">
              <Code className="w-12 h-12 mx-auto text-blue-600 mb-4" />
              <h3 className="text-xl font-bold mb-2">Interactive Cyber Law Map</h3>
              <p className="text-gray-600 max-w-md mx-auto">
                Explore how digital regulations intersect across jurisdictions
              </p>
            </div>
          </div>
        </div>
