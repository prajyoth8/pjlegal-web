  ...
  >
    ...
    >
      ...
      <div className="sticky bottom-0 bg-white border-t p-4 flex justify-between items-center">
        <button onClick={onClose} className="text-gray-600 hover:text-black font-medium px-4 py-2">
          Close
        </button>
  ...
  return (
    <PracticeDetailLayout title="Cyber Law" icon={<Globe className="w-6 h-6" />}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Modal */}
        <AnimatePresence>
          {activeCard && <ServiceModal service={activeCard} onClose={() => setActiveCard(null)} />}
        </AnimatePresence>
      </div>
    </PracticeDetailLayout>
  );
