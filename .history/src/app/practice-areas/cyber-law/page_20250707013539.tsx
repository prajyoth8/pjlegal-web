  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
          ...
          <div className="relative z-10 p-8 md:p-12 lg:p-16 text-white">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
                Navigating the <span className="text-amber-300">Evolving Cyber Legal Landscape</span>
              </h1>
              <p className="text-lg md:text-xl text-white/90 max-w-2xl mb-8">
                Comprehensive legal solutions for data protection, AI governance, and digital rights in India's fast-changing tech ecosystem.
              </p>
              <div className="flex flex-wrap gap-4">
                ...
                <a href="#trends" className="text-white border border-white/30 hover:border-white/60 px-6 py-3 rounded-lg font-medium transition-all hover:shadow-lg">
                  Emerging Threats
                </a>
              </div>
            </motion.div>
        ...
        <section id="trends" className="bg-gray-50 rounded-3xl p-8 md:p-12 mb-20 border border-gray-200">
        ...
        <section className="mb-20">
          <div className="prose prose-lg max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              <p>
                With India's digital economy projected to reach $1 trillion by 2025, cyber legal issues 
                are growing exponentially. The Digital Personal Data Protection Act 2023 establishes 
                strict compliance requirements with penalties up to ₹500 crore for violations.
              </p>
              ...
              <p>
                ...
                these complex regulations. We help clients implement compliant systems while protecting 
                their digital assets and rights.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-gradient-to-r from-blue-900 to-purple-800 rounded-3xl p-8 md:p-12 text-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-white/90 mb-6 max-w-2xl mx-auto">
              If you're experiencing an active cyber attack, data breach, or online extortion attempt, 
              we provide immediate legal assistance to mitigate damage and preserve evidence.
            </p>
