...
import CyberStats from "@/components/cyber-law/CyberStats";
import CyberLawCards from "@/components/cyber-law/CyberLawCards";
import ServiceModal from "@/components/cyber-law/ServiceModal";
import TrendSection from "@/components/cyber-law/TrendSection";
import PracticeAreasGrid from "@/components/cyber-law/PracticeAreasGrid";
import EmergencySection from "@/components/cyber-law/EmergencySection";
import ViewToggle from "@/components/cyber-law/ViewToggle";
import { services, trends } from "@/data/cyberLawData";
        ...
        {view === "services" ? (
          <>
            ...
            <div className="mt-8 text-center text-gray-500">
              ...
              <span className="block text-2xl animate-bounce mt-2">\u2B07\uFE0F</span>
            </div>
          </>
        ) : (
          <TrendSection 
            ...
            setExpandedTrend={setExpandedTrend} 
            setView={setView} 
          />
        )}
