  ...
  return (
    <PracticeDetailLayout title="Constitutional Law" icon={<Scale className="w-6 h-6" />}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-gradient-to-r from-purple-900 to-amber-800 rounded-3xl p-8 md:p-12 text-white mb-20">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <a
                  ...
                  className="text-white/90 hover:text-black underline"
                >
                  pjlegal.r@gmail.com
                </a>
              </div>
