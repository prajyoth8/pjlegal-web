...
const services = [
  {
    ...
    about: "We help you enforce your fundamental rights guaranteed under the Indian Constitution including right to equality, freedom, life and liberty.",
    highlights: [
  ...
  },
  {
    ...
    about: "PILs serve as a democratic tool to highlight issues affecting the public or marginalized sections. We draft and argue PILs with precision and constitutional sensitivity.",
    highlights: [
  ...
  },
  {
    ...
    about: "We handle all forms of writ petitions to challenge actions or inactions of state authorities violating your rights.",
    highlights: [
  ...
  },
  {
    ...
    about: "We represent clients in cases that challenge the legality and constitutionality of statutes, executive actions or regulations.",
    highlights: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative overflow-hidden rounded-3xl shadow-lg mb-16 bg-gradient-to-br from-purple-900 to-blue-900">
          ...
          <div className="relative z-10 p-8 md:p-16 text-white">
            ...
            <p className="text-lg text-white/90 mb-8 max-w-2xl">
              Expert legal services for PILs, Writs, and Constitutional remedies under the Indian Constitution.
            </p>
            <div className="flex gap-4 flex-wrap">
              ...
              <a href="#process" className="text-white border border-white/30 hover:border-white/60 px-6 py-3 rounded-lg font-medium transition">
                How We Work
              </a>
            </div>
          </div>
        ...
        {/* Services */}
        <div className="mb-20">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 text-center mb-4">Our <span className="text-purple-600">Key Services</span></h2>
          <p className="text-center text-gray-600 max-w-2xl mx-auto mb-10">
            Tailored legal strategy and court representation for constitutional violations and public interest matters.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {services.map((service, i) => (
              <motion.div
        ...
        <div id="process" className="mb-24">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 text-center mb-4">Our <span className="text-blue-600">Approach</span></h2>
          <p className="text-center text-gray-600 max-w-2xl mx-auto mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {processSteps.map((step, i) => (
              ...
              >
                <div className="mb-4 w-12 h-12 bg-indigo-50 rounded-lg flex items-center justify-center">{step.icon}</div>
                <h3 className="text-lg font-bold text-gray-800 mb-2">{step.title}</h3>
                <p className="text-gray-600">{step.description}</p>
              </motion.div>
            ))}
            ...
            >
              ...
              >
                ...
                <div className="sticky top-0 z-10 bg-white border-b border-gray-200 px-6 py-4 flex justify-between items-center">
                  ...
                  <button onClick={() => setActiveIndex(null)} className="text-gray-500 hover:text-black">
                    <X className="w-6 h-6" />
                  </button>
                </div>
