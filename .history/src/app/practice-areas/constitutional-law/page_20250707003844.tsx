...
const services = [
  {
    ...
    description: "Legal challenges against violations of Articles 14-32 of the Indian Constitution.",
  ...
  },
  {
    ...
    description: "Filing PILs for enforcement of constitutional rights affecting larger public interest.",
  ...
  },
  {
    ...
    description: "Resolution of Center-State conflicts under Articles 131, 262 and Seventh Schedule.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="relative z-10 p-8 md:p-12 lg:p-16">
            <div className="max-w-2xl">
              ...
              >
                Defending <span className="text-amber-300">Fundamental Rights</span> & Constitutional Values
              </motion.h1>
              ...
              >
                Expert legal representation for constitutional matters before High Courts and the Supreme Court of India.
              </motion.p>
              ...
              >
                ...
                <a href="#landmarks" className="text-white border border-white/30 hover:border-white/60 px-6 py-3 rounded-lg font-medium transition-all hover:shadow-lg">
                  Landmark Cases
                </a>
              </motion.div>
            </div>
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Comprehensive legal services for matters involving interpretation and enforcement of the Indian Constitution.
            </p>
          </div>
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Meticulous approach to constitutional cases ensuring thorough preparation and effective advocacy.
            </p>
          </div>
        ...
        <div id="landmarks" className="bg-gray-50 rounded-3xl p-8 md:p-12 mb-20 border border-gray-200">
        ...
        <div className="mb-20">
          ...
          <div className="prose prose-lg max-w-3xl mx-auto text-gray-700">
            <p>
              Constitutional law forms the foundation of India's legal system, protecting citizens' fundamental rights 
              and defining the relationship between individuals and the State. Our Constitution establishes the framework 
              for governance while safeguarding democratic principles and the rule of law.
            </p>
            
            <h3 className="text-xl font-bold text-gray-800 mt-8">Key Constitutional Principles:</h3>
            <ul className="space-y-2">
              <li><strong>Judicial Review:</strong> Power of courts to examine legislative and executive actions</li>
              <li><strong>Basic Structure Doctrine:</strong> Limits on Parliament's amendment power</li>
              <li><strong>Separation of Powers:</strong> Balance between Legislature, Executive and Judiciary</li>
              <li><strong>Federalism:</strong> Distribution of powers between Center and States</li>
            </ul>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-blue-900 to-indigo-800 rounded-3xl p-8 md:p-12 text-white mb-20">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Need Constitutional Legal Assistance?</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <a href="mailto:constitution@lawfirm.com" className="text-white/90 hover:text-white underline">
