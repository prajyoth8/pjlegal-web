...
import { ArrowLeft, Clock, Eye, User, MessageSquare, ChevronRight, Bookmark } from "lucide-react";
...
export default function ArticleClientPage({ article, related }: { article: any; related: any[] }) {
                ...
                <motion.div key={item.id} whileHover={{ y: -5 }} transition={{ duration: 0.2 }}>
                  ...
                  >
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-sm text-neutral-500 mb-4 line-clamp-2">{item.summary}</p>
        ...
        <section className="mt-16 border-t border-neutral-200 pt-12">
          ...
          <div className="bg-neutral-50 rounded-xl p-8 text-center">
            <p className="text-neutral-500">
              We're working on adding comments to enhance discussion.
            </p>
