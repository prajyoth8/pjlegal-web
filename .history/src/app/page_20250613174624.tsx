        ...
        <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex items-center justify-center">
          <div className="bg-white p-6 rounded-xl max-w-lg w-full shadow-xl border border-gray-300">
            ...
            <ul className="text-sm text-gray-700 list-disc pl-5 space-y-2">
              ...
              <li>
                The information is made available only on specific request. Download or use is at the user&apos discretion and does not create a lawyer-client relationship.
              </li>
              <li>
