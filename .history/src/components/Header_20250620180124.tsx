...
export default function Header() {
  const { theme, setTheme } = useTheme(); // ✅ CORRECT PLACE: inside component function
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            {/* Theme toggle button */}
            <button
              className="text-sm text-white px-3 py-1 rounded border border-white/30 hover:bg-white/10"
        ...
        {/* Search & Mobile Menu (same as before) */}
        {searchOpen && (
