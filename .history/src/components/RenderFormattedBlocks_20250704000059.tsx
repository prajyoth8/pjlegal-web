    ...
    <div className="space-y-3">
      {blocks.map((block, index) => {
        switch (block.type) {
          ...
          case 'heading_2':
            return <h2 key={index} className="text-xl font-bold">{block.text}</h2>;
          case 'heading_3':
            return <h3 key={index} className="text-lg font-semibold">{block.text}</h3>;
          case 'heading_4':
            return <h4 key={index} className="text-md font-medium">{block.text}</h4>;
          case 'paragraph':
            ...
            return (
              <ol key={index} className="list-decimal pl-6">
                {block.items.map((item, i) => (
                  <li key={i} className="my-1">{item.text}</li>
                ))}
              </ol>
            );
          case 'unordered_list':
