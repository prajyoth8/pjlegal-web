...
export default function Sidebar({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
  ...
  return (
    <>
      ...
      {/* Sidebar - using flex-col and overflow-hidden */}
      <aside
        className={clsx(
          "fixed top-0 left-0 h-screen w-64 bg-[#111827] text-white z-50",
          "flex flex-col",
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          <div className="p-4 space-y-2">
            ...
            <button
              className="w-full mt-6 mb-4 bg-amber-600 hover:bg-amber-700 text-white font-bold py-2 px-4 rounded-md transition"
        ...
        {/* Footer Items - non-scrolling but always visible */}
