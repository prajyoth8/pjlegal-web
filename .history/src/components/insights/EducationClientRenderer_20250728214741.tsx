    ...
    items: [
      {
        ...
        explanation: `The Constitution of India guarantees six fundamental rights to all citizens:
      ...
      },
      {
        ...
        explanation: `Key safeguards under Bharatiya Nagarik Suraksha Sanhita:
        1. Arrest memo mandatory with digital copy to family/lawyer within 2 hrs (Sec 35)
        2. Medical examination within 48 hours of arrest (Sec 36)
        3. No custody beyond 24 hrs without magistrate approval (Sec 37)
        4. Right to legal aid from moment of arrest (Sec 38)

        Comparison with old CrPC:
        - CrPC Section 50: Basic arrest rights
        - BNSS Section 35: Digital documentation and tracking
  ...
  items: [
    {
      ...
      2. <strong>Bail: Temporary release of an accused person awaiting trial (BNSS Section 479)
      3. <strong>Cognizable Offense: Serious crime where police can arrest without warrant (BNSS Section 173)
      4. <strong>Decree: Final order of a court in civil cases (CPC Section 2(2))
      5. <strong>Ex parte: Proceeding where one party is absent`,
