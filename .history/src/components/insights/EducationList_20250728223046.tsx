      ...
      {educationSections.map((section) => (
        ...
        >
          <Link
            ...
            className={`block bg-gradient-to-br ${section.gradient} border border-gray-200 dark:border-gray-700 rounded-2xl p-2 h-full transition-all hover:shadow-lg hover:border-transparent`}
          >
