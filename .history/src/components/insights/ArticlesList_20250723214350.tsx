...
export default function ArticlesList() {
  ...
  const [query, setQuery] = useState(""); // 🔍 Real-time search query
  ...
  className="w-full md:w-1/2 mb-6 px-4 py-2 rounded-md bg-neutral-800 text-neutral-200 border border-neutral-700 placeholder-neutral-500 focus:outline-none focus:ring-2 focus:ring-cyan-500"
/>
