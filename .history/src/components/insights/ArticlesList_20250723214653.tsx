...
export default function ArticlesList() {
  ...
  <input
    ...
    className="w-full sm:w-2/3 px-4 py-2 rounded-md bg-neutral-800 text-neutral-200 border border-neutral-700 placeholder-neutral-500 focus:outline-none focus:ring-2 focus:ring-cyan-500"
  />

  <div className="flex items-center gap-2">
    <label htmlFor="sort" className="text-sm text-neutral-400">Sort by:</label>
    <select
      id="sort"
      value={sortOrder}
      onChange={(e) => setSortOrder(e.target.value as "newest" | "oldest")}
      className="bg-neutral-800 text-neutral-100 border border-neutral-700 px-3 py-1 rounded-md text-sm"
    >
