  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <header className="mb-8 text-center md:text-left">
        ...
        {id === "new-criminal-laws" && (
          <div className="mt-4 p-4 bg-yellow-50 dark:bg-yellow-900/10 border-l-4 border-yellow-400">
      ...
      <div className="grid grid-cols-1 gap-6">
        {section.items.map((item, index) => (
          <div key={index} className={`bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden transition-all duration-300 ${openItems[index] ? 'ring-2 ring-blue-500' : 'hover:shadow-lg'}`}>
            <button
            ...
            >
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white">{item.topic}</h3>
              <span className="text-blue-500">
                {openItems[index] ? <FiChevronUp size={24} /> : <FiChevronDown size={24} />}
              </span>
            </button>
            ...
            {openItems[index] && (
              <div className="px-6 pb-6 pt-2 border-t border-gray-200 dark:border-gray-700">
                ...
                {item.relatedLaws && (
                  <div className="mt-4">
                    <h4 className="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Related Legal Provisions</h4>
                    <div className="flex flex-wrap gap-2">
      ...
      <div className="mt-12 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-gray-800 dark:to-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700">
        <div className="flex flex-col md:flex-row items-center gap-6">
          ...
          <div>
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Official Resources</h3>
