    ...
    <div className="space-y-4 text-[15px] leading-[1.6]">
      ...
      <div className="flex justify-between items-center mb-2">
        <div className="flex gap-2 items-center">
          <button
            className={`px-3 py-1 rounded-md text-sm font-semibold ${
              viewMode === "blocks" ? "bg-gray-800 text-white" : "bg-gray-200 text-gray-800"
            }`}
          ...
          <button
            className={`px-3 py-1 rounded-md text-sm font-semibold ${
              viewMode === "raw" ? "bg-gray-800 text-white" : "bg-gray-200 text-gray-800"
            }`}
        ...
        <div className="flex items-center gap-2">
          <label className="text-sm font-semibold text-gray-500">🔧 Dev Mode</label>
          <input
            type="checkbox"
            checked={devMode}
            onChange={() => setDevMode(!devMode)}
      ...
      ) : viewMode === "raw" && rawText ? (
        <div className="whitespace-pre-wrap bg-white text-gray-900 p-4 rounded-md border border-gray-200 text-[15px] leading-[1.6]">
          {rawText}
        </div>
      ) : (
        groupedBlocks.map((block, index) => {
