  ...
  const practiceSubItems = [
    {
      ...
      sub: [
        ...
        { name: "Criminal Litigation", href: "/practice-areas/litigation/criminal" },
      ],
    },
    {
      name: "Contracts",
    ...
    },
    {
      ...
      sub: [
        ...
        { name: "Trademark Registration", href: "/practice-areas/ip/trademarks" },
      ],
    },
    {
      name: "Legal Advisory",
      ...
      sub: [
        { name: "Startup Consulting", href: "/practice-areas/advisory/startups" },
        { name: "Regulatory Advice", href: "/practice-areas/advisory/regulatory" },
      ],
    },
    {
