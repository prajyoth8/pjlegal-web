// ✅ 1. ContactSection.tsx (Trendy redesign with animation & clean layout)
"use client";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            <form
              ...
              className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-xl space-y-5"
            >
              <input
                type="text"
                ...
                className="w-full p-3 rounded-lg border dark:bg-gray-700 dark:text-white text-black focus:ring-2 focus:ring-blue-600"
              />
              <input
                type="email"
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-blue-700 hover:bg-blue-800 text-white py-3 rounded-lg text-lg font-medium"
              >
            ...
            {[
              {
                ...
                address: "Prakashnagar, Begumpet, Hyderabad, Telangana 500001",
