...
export default function ChatAuthModal({
  ...
  return (
    <div className="p-6 rounded-xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 shadow-lg max-w-md w-full mx-4">
      {/* Welcome Header */}
      ...
      <div className="space-y-4">
        {step === "input" ? (
          <>
            <div>
              <label htmlFor="contact-input" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
          ...
          <>
            <div>
              <label htmlFor="otp-input" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                Verification Code
              </label>
              <input
                id="otp-input"
