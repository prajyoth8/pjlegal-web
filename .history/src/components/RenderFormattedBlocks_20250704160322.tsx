...
type FormattedBlock = ParagraphBlock | HeadingBlock | QuoteBlock | ListBlock | TableBlock;
        ...
        switch (block.type) {
          ...
          case "table":
            return (
              <table
                key={index}
                className="table-auto border border-collapse border-gray-400 text-sm text-left"
              >
                <tbody>
