    ...
    try {
      const res = await fetch(`${BACKEND_URL}/auth/send-otp`, {
        ...
        body: JSON.stringify({ 
          ...
          method: authMethod,
          // Include formatted phone number explicitly
      ...
      // Update value with formatted phone number if needed
      if (authMethod === "phone") {
    ...
    try {
      const res = await fetch(`${BACKEND_URL}/auth/verify-otp`, {
        ...
        body: JSON.stringify({ 
          ...
          otp, 
          method: authMethod,
          // Explicitly include phone/email in verification
          phone_number: authMethod === "phone" ? value : null,
      ...
      // Verify the session was created with the correct details
      const sessionRes = await fetch(`${BACKEND_URL}/auth/verify-session`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
