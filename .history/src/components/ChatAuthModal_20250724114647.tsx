...
export default function ChatAuthModal({
  ...
  const isValidPhone = (phone: string) => {
    // Basic international phone validation (minimum 7 digits after country code)
    ...
    try {
      const res = await fetch(`${BACKEND_URL}/auth/verify-otp`, {
        ...
        body: JSON.stringify({ 
          ...
          otp, 
          method: authMethod,
          phone_number: authMethod === "phone" ? formatPhoneNumber(value) : null
        }),
      });
            ...
            <div>
              ...
              {authMethod === "email" ? (
                ...
                <PhoneInputWithCountry 
                  ...
                  onBlur={() => setValue(formatPhoneNumber(value))}
                />
              )}
            </div>
            <button
