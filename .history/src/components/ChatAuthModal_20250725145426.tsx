...
export default function ChatAuthModal({
  ...
  //   console.log("📲 Sending for verify:", {
  //     contact: value,
  //     mobile_number: formatPhoneNumber(value),
  //   });
  ...
  //         otp,
  //         method: authMethod,
  //         mobile_number: authMethod === "phone" ? formatPhoneNumber(value) : null,
  //       }),
  //     });
...
const verifyOtpAndCreateSession = async () => {
  ...
  try {
    ...
    onAuthenticated(data.session_token, data.contact);
