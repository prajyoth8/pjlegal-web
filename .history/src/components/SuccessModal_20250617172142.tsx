...
import successAnimation from "@/public/assets/lottie/success.json"; // ✅ Correct import for TypeScript
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex items-center justify-center">
      <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-xl max-w-sm w-full text-center">
        ...
        />
        <h2 className="text-xl font-semibold text-green-600 mt-4">Message Sent!</h2>
