  ...
  return (
    <div className="p-4 rounded-xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700">
      ...
      <div className="bg-gradient-to-br from-sky-200 to-sky-400 text-gray-900 dark:text-white p-3 rounded-xl mb-4 max-w-[85%]">
        <p>
          <strong>Hello!</strong> I'm PJ Legal AI Assistant.<br />
          How can I help you <span className="text-green-700 font-mono">with your legal questions today?</span>
        </p>
      </div>
        ...
        {step === "verify" && (
          <>
            ...
            <p className="text-xs text-gray-500 mt-3">
              Didn't get the code? <button onClick={handleSendOtp} className="text-amber-600 underline">Resend</button>
            </p>
          </>
        )}
