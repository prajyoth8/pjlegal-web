  ...
  const practiceSubItems = [
    {
      ...
      ].map((name) => ({ name, href: "/practice-areas/banking#" + name.toLowerCase().replace(/\s+/g, "-") })),
    },
    {
      ...
      ].map((name) => ({ name, href: "/practice-areas/competition#" + name.toLowerCase().replace(/\s+/g, "-") })),
    },
    {
      name: "Corporate & M&A",
      ...
      sub: [
        ...
        "General Corporate",
        "ESG",
      ].map((name) => ({ name, href: "/practice-areas/corporate#" + name.toLowerCase().replace(/\s+/g, "-") })),
    },
    {
      ...
      ].map((name) => ({ name, href: "/practice-areas/dispute#" + name.toLowerCase().replace(/\s+/g, "-") })),
    },
    {
      ...
      ].map((name) => ({ name, href: "/practice-areas/employment#" + name.toLowerCase().replace(/\s+/g, "-") })),
    },
    {
      ...
      ].map((name) => ({ name, href: "/practice-areas/environment#" + name.toLowerCase().replace(/\s+/g, "-") })),
    },
    {
      ...
      ].map((name) => ({ name, href: "/practice-areas/ip#" + name.toLowerCase().replace(/\s+/g, "-") })),
    },
    {
      ...
      sub: [
        ...
        "Wealth Management",
        "Family Constitution",
      ].map((name) => ({ name, href: "/practice-areas/private#" + name.toLowerCase().replace(/\s+/g, "-") })),
    },
    {
      ...
      sub: [
        ...
        "Leases & Licenses",
      ].map((name) => ({ name, href: "/practice-areas/realestate#" + name.toLowerCase().replace(/\s+/g, "-") })),
    },
    {
      ...
      ].map((name) => ({ name, href: "/practice-areas/insolvency#" + name.toLowerCase().replace(/\s+/g, "-") })),
    },
    {
      name: "Taxation",
      ...
      ].map((name) => ({ name, href: "/practice-areas/tax#" + name.toLowerCase().replace(/\s+/g, "-") })),
    },
    {
      ...
      sub: [
        ...
        "Gaming & OTT",
        "Cybersecurity",
      ].map((name) => ({ name, href: "/practice-areas/technology#" + name.toLowerCase().replace(/\s+/g, "-") })),
    },
  ];
