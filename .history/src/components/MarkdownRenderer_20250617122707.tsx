...
const markdownComponents: Components = {
  h1: ({ children, ...props }) => (
    <h1 className="text-3xl font-bold my-4 text-neutral-800 dark:text-white" {...props}>
      {children}
    </h1>
  ),
  h2: ({ children, ...props }) => (
    <h2 className="text-2xl font-semibold my-3 text-neutral-700 dark:text-white" {...props}>
      {children}
    </h2>
  ),
  p: ({ children, ...props }) => (
