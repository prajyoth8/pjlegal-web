...
export type LegalDocument = {
  ...
  category: string;
  region: string;
  tags?: string | null; // Make tags optional and nullable
  file_url: string;
  uploaded_at: string;
};
    ...
    <div className="bg-neutral-950 text-neutral-100 min-h-screen p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        <div className="relative">
          <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
            <svg className="h-4 w-4 text-neutral-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      {isLoading ? (
        ...
        <div className="bg-neutral-900/50 rounded-xl border border-neutral-800 p-8 text-center">
          <svg className="mx-auto h-12 w-12 text-neutral-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="overflow-hidden rounded-xl border border-neutral-800 shadow-lg">
          <table className="min-w-full divide-y divide-neutral-800">
            ...
            <tbody className="bg-neutral-900/50 divide-y divide-neutral-800">
              {paginatedDocs.map((doc) => (
                <tr key={doc.id} className="hover:bg-neutral-900 transition-colors">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-neutral-400">
                    <div className="flex flex-wrap gap-1">
                      {doc.tags.split(',').map(tag => (
                        <span key={tag} className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-neutral-800 text-neutral-300">
                          {tag.trim()}
                        </span>
                      ))}
                    </div>
          ...
          <div className="bg-neutral-900 px-6 py-3 flex items-center justify-between border-t border-neutral-800">
            <div className="text-sm text-neutral-400">
              ...
              <span className="font-medium">{Math.min(currentPage * pageSize, documents.length)}</span> of{' '}
