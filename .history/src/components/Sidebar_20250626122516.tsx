...
export default function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={clsx(
          "fixed top-0 left-0 h-full w-64 z-40 bg-[#111827] text-white p-4 shadow-lg transition-transform duration-300",
          {
            "-translate-x-full": !isOpen,
            "translate-x-0": isOpen,
            "lg:-translate-x-full lg:group-[.sidebar-open]:translate-x-0": true,
          }
        )}
      >
