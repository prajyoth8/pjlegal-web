...
type TextBlock = {
  type: "paragraph" | "heading_1" | "heading_2" | "heading_3" | "heading_4" | "subheading" | "quote";
  text: string;
};
...
type ListBlock = {
  ...
  next_number?: number; // Only for ordered lists
};
    ...
    <div className="space-y-4 text-gray-800">
      {blocks.map((block, index) => {
        ...
        if ('text' in block) {
          switch (block.type) {
            case "heading_1":
              return <h1 key={index} className="text-3xl font-bold my-4" dangerouslySetInnerHTML={{ __html: block.text }} />;
            case "heading_2":
              return <h2 key={index} className="text-2xl font-bold my-3" dangerouslySetInnerHTML={{ __html: block.text }} />;
            case "heading_3":
              return <h3 key={index} className="text-xl font-semibold my-2" dangerouslySetInnerHTML={{ __html: block.text }} />;
            case "heading_4":
            case "subheading":
              return <h4 key={index} className="text-lg font-medium my-2" dangerouslySetInnerHTML={{ __html: block.text }} />;
            case "paragraph":
              return <p key={index} className="my-2 leading-relaxed" dangerouslySetInnerHTML={{ __html: block.text }} />;
            case "quote":
              return <blockquote key={index} className="border-l-4 border-gray-300 pl-4 italic my-2" dangerouslySetInnerHTML={{ __html: block.text }} />;
            default:
              return null;
          }
        }
