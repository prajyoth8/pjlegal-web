...
export default function WelcomeSection() {
  ...
  return (
    <section className="relative w-full bg-white py-12 px-4 sm:px-6 lg:px-8 flex justify-center overflow-hidden">
      ...
      >
        <a href="#next-section" className="absolute bottom-6 left-1/2 transform -translate-x-1/2 z-20">
  <ArrowDownCircle className="h-10 w-10 text-blue-600 hover:text-blue-800 transition-all animate-bounce cursor-pointer" />
</a>
