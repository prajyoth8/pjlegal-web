  ...
  return (
    <section className="relative w-full h-[500px] bg-white overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          src="/assets/hero_office_pjlegal.png" // 📌 Replace with generated image path
      ...
      <div className="relative z-10 flex flex-col items-start justify-center h-full max-w-6xl mx-auto px-6 md:px-10">
        ...
        <p className="mt-4 text-lg md:text-xl text-gray-800 max-w-xl leading-relaxed">
          Blending legal wisdom. Empowering{" "}// ✅ src/components/light/WelcomeSection.tsx
import Image from "next/image";
...
export default function WelcomeSection() {
  return (
    <section className="relative w-full h-[520px] overflow-hidden bg-white">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          src="/assets/pj_legal_sign_wall.png" // 🖼️ Replace with your uploaded path
          alt="PJ Legal Sign"
          fill
          priority
