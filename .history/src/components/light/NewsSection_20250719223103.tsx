...
export default function NewsSection({ news = [], articles = [], blogs = [] }: NewsSectionProps) {
  const featuredNews = news[0] || {
    ...
    imageUrl: "/legal-news-default.jpg",
    location: ["india"],
    content: "",
  };
    ...
    <section className="bg-gradient-to-b from-gray-50 to-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex space-x-4 border-b border-gray-200 mb-6">
          ...
          <button className="py-2 px-4 text-gray-500 hover:text-gray-700 font-medium">News</button>
          <button className="py-2 px-4 text-gray-500 hover:text-gray-700 font-medium">
            Articles
          </button>
          <button className="py-2 px-4 text-gray-500 hover:text-gray-700 font-medium">Blogs</button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="relative h-48">
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent p-4">
                <span className="inline-block bg-indigo-600 text-white text-xs px-2 py-1 rounded-md mb-2">
                  {featuredNews.location.includes("telangana") ? "Telangana News" : "India News"}
                </span>
                <h3 className="text-white font-bold text-lg">{featuredNews.title}</h3>
              </div>
            </div>
            <div className="p-6">
              <div className="flex items-center text-sm text-gray-500 mb-2">
                ...
                <span>
                  {new Date(featuredNews.date).toLocaleDateString("en-IN", {
                    day: "numeric",
                    month: "short",
                    year: "numeric",
                  })}
          ...
          <div className="space-y-6">
            ...
            {articles.length === 0 && (
              <div className="bg-white rounded-lg shadow-md overflow-hidden p-6 text-center text-gray-500">
