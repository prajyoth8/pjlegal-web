...
const ContactSection = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Mail,
      title: 'Email',
      details: ['contact@pjlegal.in', 'info@pjlegal.in'],
      action: 'Send Email',
    },
    {
      icon: MapPin,
      title: 'Office',
      details: ['123 Legal District', 'New Delhi, India 110001'],
    ...
    <section id="contact" className="py-20 bg-slate-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      {info.details.map((detail, i) => (
                        <p key={i} className="text-slate-300 text-sm mb-1">{detail}</p>
                      ))}
            ...
            <div className="bg-slate-800/50 p-8 rounded-2xl border border-slate-700/50">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <label className="block text-sm text-slate-300 mb-2">Legal Area *</label>
                    <select
                      name="subject"
                      value={formData.subject}
                      onChange={handleChange}
                      required
                      className="w-full px-4 py-3 bg-slate-700/50 border border-slate-600 rounded-xl text-white focus:border-amber-500 focus:ring-1 focus:ring-amber-500"
                    >
        ...
        <div className="mt-20">
          <iframe
            title="PJ Legal Map"
            className="w-full h-96 rounded-xl border-2 border-slate-800"
            loading="lazy"
            allowFullScreen
