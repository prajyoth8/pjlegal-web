  ...
  return (
    <section id="about" className="py-20 bg-white">
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          <h1>
            <span className="inline-block px-4 py-1 mb-4 md:text-2xl font-bold text-amber-600 bg-amber-50 rounded-full">
              ABOUT
            </span>
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          >
            ...
            <p className="text-gray-600">
              With a rare blend of tech expertise (Salesforce/SAP/Cyber Security, AI from IIT
              Roorkee) and legal education, we bring fresh perspectives to traditional legal
              challenges.
            </p>
