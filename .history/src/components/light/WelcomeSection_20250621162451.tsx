    ...
    <section className="relative w-full bg-white py-20 px-4 md:px-8 lg:px-16">
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-10 px-8 py-12">
          {/* Left Section */}
          <div className="max-w-xl text-center lg:text-left pl-2 lg:pl-6 lg:translate-x-4 transition-transform duration-500">
            <motion.div
          ...
          <motion.div
            ...
            className="w-full max-w-sm lg:-translate-x-4 transition-transform duration-500"
          >
            <Image
