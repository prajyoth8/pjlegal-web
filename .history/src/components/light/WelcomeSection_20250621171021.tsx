  ...
  return (
    <section className="relative w-full bg-white py-12 px-4 sm:px-6 lg:px-8 flex justify-center overflow-hidden">
      ...
      <motion.div
        ...
        className="relative w-full max-w-7xl rounded-3xl shadow-2xl bg-[url('/assets/wall_gradient_bg.png')] bg-cover bg-center px-4 sm:px-6 lg:px-12 py-16 sm:py-20 text-center flex flex-col items-center hover:shadow-yellow-200 hover:shadow-[0_0_50px_0_rgba(255,223,0,0.3)] transition-all duration-500"
      >
        {/* 🔽 Enhanced Auto-scroll Hint */}
        <a
          href="#next-section"
          className="absolute bottom-6 left-1/2 transform -translate-x-1/2 z-20 flex flex-col items-center group cursor-pointer"
        >
          <span className="text-sm font-medium text-gray-500 group-hover:text-gray-700 mb-1 transition">
            Scroll Down
          </span>
          <ChevronDown className="h-6 w-6 text-gray-500 animate-bounce group-hover:text-blue-600" />
          <ChevronDown className="h-6 w-6 text-gray-400 -mt-1 animate-bounce group-hover:text-blue-500 delay-150" />
        </a>
