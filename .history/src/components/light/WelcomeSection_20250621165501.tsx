...
export default function WelcomeSection() {
  ...
  className="relative z-10 w-full max-w-5xl rounded-3xl shadow-2xl px-6 sm:px-10 lg:px-14 py-16 sm:py-20 text-center flex flex-col items-center overflow-hidden"
>
  {/* 🔳 Wall Gradient Card Background */}
