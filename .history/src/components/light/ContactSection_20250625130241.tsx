...
const ContactSection = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      action: "View on Map",
      mapEmbed:
        "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d60561.20757594816!2d79.09194859174164!3d18.434882034129032!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bccd910bcf48931%3A0x4889b0398ed69f07!2sKarimnagar%2C%20Telangana!5e0!3m2!1sen!2sin!4v1750162608292!5m2!1sen!2sin",
    },
    {
      icon: MapPin,
      ...
      action: "View on Map",
      mapEmbed:
        "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3806.382526149176!2d78.46648702591123!3d17.441396051245547!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcb90a5d40aa43f%3A0x759891c5155b2eac!2sPrakash%20Nagar%2C%20Begumpet%2C%20Hyderabad%2C%20Telangana%20500016!5e0!3m2!1sen!2sin!4v1750162240236!5m2!1sen!2sin",
    },
  ];
          ...
          <div>
            <div className="space-y-8">
              {contactInfo.map((info, index) => (
                <div
                  key={index}
                  className="bg-slate-800/50 p-5 rounded-xl border border-slate-700/50 hover:border-amber-500/50 transition-all duration-300"
                >
                    ...
                    <div>
                      ...
                      {info.link && (
                        <a
                          ...
                          className="inline-block text-amber-400 text-sm font-medium hover:text-amber-300 transition mt-1"
                        >
                          {info.action} →
                        </a>
                      )}
  ...
  <p className="text-slate-400 mb-4 font-medium text-sm uppercase tracking-wide">
    Connect with us on social media
  </p>
  <div className="flex flex-wrap justify-center gap-4">
    {/* Keep only social icons below */}
    ...
    <a href="https://twitter.com" className="text-sky-500 hover:scale-110 text-2xl transition"><FaXTwitter /></a>
  </div>
</div>
