    ...
    <section id="practice" className="relative py-24 overflow-hidden bg-[#f9fafb]">
      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          >
            Specialized legal services tailored to your unique needs with our multidisciplinary approach
          </motion.p>
        </div>
        ...
        >
          {practiceAreas.map(({ name, slug, icon, gradient }) => (
            <motion.div key={slug} variants={item} className="h-full">
              <Link href={`/practice-areas/${slug}`} className="group block h-full">
                <div className="h-full bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 group-hover:-translate-y-2 border border-gray-100 hover:border-transparent relative overflow-hidden">
                  ...
                  <div className={`absolute inset-0 bg-gradient-to-br opacity-0 group-hover:opacity-10 ${gradient} transition-opacity duration-300`}></div>
                  
                  <div className="relative z-10">
                    <div className="flex items-start">
                      <div className={`text-3xl mr-4 transition-transform duration-300 group-hover:scale-110 group-hover:text-white bg-gradient-to-br ${gradient} p-2 rounded-lg`}>
                        {icon}
                      </div>
                      <div>
                     ...
                     <motion.div
     <div className={`mt-2 w-8 h-1 rounded-full bg-gradient-to-r ${gradient} group-hover:w-12 transition-all duration-300`}></div>
                      </div>
                    </div>
