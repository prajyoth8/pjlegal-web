  ...
  return (
    <section className="relative w-full bg-white py-12 px-4 sm:px-6 lg:px-8 flex justify-center overflow-hidden">
      ...
      <motion.div
        ...
        className="relative w-full max-w-7xl rounded-3xl shadow-2xl bg-[url('/assets/hero_dark.jpg')] bg-cover bg-center px-4 sm:px-6 lg:px-12 py-16 sm:py-20 text-center flex flex-col items-center hover:shadow-yellow-200 hover:shadow-[0_0_50px_0_rgba(255,223,0,0.3)] transition-all duration-500"
      >
        {/* 🔽 Auto-scroll Hint */}
        <a
          href="#next-section"
