...
const images = [
  {
    ...
    description: "Automate repetitive legal tasks, document review, and contract management using AI-driven workflows. Improve turnaround time and reduce manual errors.",
  },
  {
    src: "/assets/carousel2.png",
    title: "Cybersecurity & Law",
    caption: "Protection for digital assets & breaches",
    description: "Safeguard digital information and mitigate cyber threats by integrating legal compliance with AI-based cybersecurity assessment and alert systems.",
  },
  {
    src: "/assets/carousel3.png",
    title: "Litigation Support",
    caption: "Evidence handling & court preparation",
    description: "Assist legal teams with structured tools for managing case files, preparing witness lists, and organizing digital evidence for trial use.",
  },
  {
    src: "/assets/carousel4.png",
    title: "HR & Labor Law",
    caption: "Hiring, workplace & policy compliance",
    description: "Ensure your hiring process, workplace policies, and labor contracts comply with evolving employment laws and regulatory standards.",
  },
  {
    src: "/assets/carousel5.png",
    title: "Corporate Governance",
    caption: "Boards, policies & legal compliance",
    description: "Enable transparent and legally sound governance by structuring board decisions, compliance logs, and regulatory documentation using smart tools.",
  },
  {
    src: "/assets/carousel6.png",
    title: "AI for Legal Drafting",
    caption: "Smarter agreements and notices",
    description: "Draft customized legal documents with AI assistance—ranging from contracts to notices, all while ensuring accuracy, relevance, and legal conformity.",
  },
  {
    src: "/assets/carousel7.png",
    title: "Legal Research Intelligence",
    caption: "Extract insights from vast legal data",
    description: "Use AI to analyze case law, statutes, and judgments. Get instant summaries, legal issue mapping, and precedent suggestions from vast databases.",
  },
];
