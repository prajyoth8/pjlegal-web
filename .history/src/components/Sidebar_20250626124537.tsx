...
export default function Sidebar({ isOpen, onClose, isMobile = false }: SidebarProps) {
  ...
  return (
    <aside
  className={clsx(
    "bg-[#111827] text-white w-64 h-full lg:static fixed top-0 left-0 z-50 transform transition-transform duration-300",
    isOpen ? "translate-x-0" : "-translate-x-full",
    "lg:translate-x-0 lg:z-auto lg:block" // Always visible in large screen
  )}
>
