        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <div className="space-y-8">
            ...
            >
              ...
              <iframe
                src="git add src/components/SuccessModal.tsx
git commit -m "fix: updated Lottie animationData import to fix build failure"
git push origin main" // replace with real map
                width="100%"
                height="200"
                style={{ border: 0 }}
                allowFullScreen
