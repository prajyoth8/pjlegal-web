          ...
          <tr>
            <td style="padding: 30px;">
              ...
              <div style="margin-top: 20px;">
                <h3 style="color: #111827; font-size: 16px; margin-bottom: 10px;">📋 Message Summary</h3>
                <table cellpadding="5" cellspacing="0" width="100%" style="font-size: 14px;">
              ...
              <p style="margin-top: 25px;">
                🔒 We maintain strict confidentiality. Thank you for trusting PJ Legal.
              </p>
